      ...
      <div className="blogPageContainer">
        <div className="blogContent">
          <div className="blogContentHeader">
            <div
              className="blogImage"
              style={{ backgroundImage: `url(/eventPics/sail.png` }}
            />
            <div className="blogHeaderInfo">
              <h1>Jimmy Key Universail Yat Yarışları</h1>
              ...
              <div className="blogLocTime">
                ...
                <div className="blogDate">9 July 2023</div>
              </div>
              ...
              <div className="blogOraganizator">
                <div
                  ...
                  style={{
                    backgroundImage: `url(/organizatorLogos/uriyat.png`,
                  }}
                />
                <h3>URİYAT</h3>
              </div>
