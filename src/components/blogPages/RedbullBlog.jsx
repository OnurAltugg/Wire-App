      ...
      <div className="blogPageContainer">
        <div className="blogContent">
          <div className="blogContentHeader">
            <div
              className="blogImage"
              style={{ backgroundImage: `url(/eventPics/redbull.webp` }}
            />
            <div className="blogHeaderInfo">
              <h1>Redbull Half Court Regional Finals</h1>
              ...
              <div className="blogLocTime">
                ...
                <div className="blogDate">8 August 2023</div>
              </div>
              ...
              <div className="blogOraganizator">
                <div
                  ...
                  style={{
                    backgroundImage: `url(/organizatorLogos/redbull.png`,
                  }}
                />
                <h3>Redbull</h3>
              </div>
